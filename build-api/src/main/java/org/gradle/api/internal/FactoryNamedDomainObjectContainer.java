...
public class FactoryNamedDomainObjectContainer<T> extends AbstractNamedDomainObjectContainer<T> {
     ...
     */
    public FactoryNamedDomainObjectContainer(Class<T> type, Instantiator instantiator, final Function<String,Object> factoryClosure, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
     ...
     */
    public FactoryNamedDomainObjectContainer(Class<T> type, Instantiator instantiator, Namer<? super T> namer, Function<String,Object> factoryClosure, MutationGuard mutationGuard, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
        this(type, instantiator, namer, new FunctionObjectFactory<>(type, factoryClosure), mutationGuard, collectionCallbackActionDecorator);
    }
    ...
    private static class FunctionObjectFactory<T> implements NamedDomainObjectFactory<T> {
        private final Class<T> type;
        private final Function<String,Object> factoryClosure;

        public FunctionObjectFactory(Class<T> type, Function<String,Object> factoryClosure) {
            this.type = type;
        ...
        public T create(String name) {
            return type.cast(factoryClosure.apply(name));
        }
    }
