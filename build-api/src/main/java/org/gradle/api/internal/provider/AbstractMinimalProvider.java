...
public abstract class AbstractMinimalProvider<T> implements ProviderInternal<T>, Managed {
    ...
    protected abstract Value<? extends T> calculateOwnValue(ValueConsumer consumer);
    ...
    private String cannotQueryValueOf(Value<? extends T> value) {
        ...
        return "Cannot query the value of " + getDisplayName().getDisplayName() + " because it has no value available.";
    }
}
