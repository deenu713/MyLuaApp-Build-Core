...
public abstract class AbstractProperty<T, S extends ValueSupplier> extends AbstractMinimalProvider<T> implements PropertyInternal<T> {
    ...
    public void attachProducer(ModelObject owner) {
        if (this.producer == null) {
            ...
            throw new IllegalStateException("Property " + getDisplayName().getCapitalizedDisplayName() + " is already declared as an output property of " + this.producer + ". Cannot also declare it as an output property of " + owner + ".");
