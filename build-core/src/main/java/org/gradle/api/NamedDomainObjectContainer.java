 ...
 *
 * <p>You can create an instance of this type using the factory method.</p>
 *
...
public interface NamedDomainObjectContainer<T> extends NamedDomainObjectSet<T>, Configurable<NamedDomainObjectContainer<T>> {
     ...
     */
    @Override
    NamedDomainObjectContainer<T> configure(Function< NamedDomainObjectContainer<T>, NamedDomainObjectContainer<T>> configureClosure);
     ...
     *
     * <p>It is generally more efficient to use this method instead of {@link #create(String)}, as that method will eagerly create the object, regardless of whether that object is required for the current build or not. This method, on the other hand, will defer creation until required.</p>
     *
     * @param name The name of the object.
     * @return A {@link Provider} that whose value will be the object, when queried.
     * @throws InvalidUserDataException If a object with the given name already exists in this project.
