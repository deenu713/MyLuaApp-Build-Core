...
public interface CacheBuilder {
     ...
     * <ul>
     *     <li>Using {@link FileLockManager.LockMode#Exclusive} will lock the cache on open() and keep it locked until {@link PersistentCache#close()} is called.</li>
     *     <li>Using {@link FileLockManager.LockMode#OnDemand} or {@link FileLockManager.LockMode#Shared} will <em>not</em> lock the cache on open().</li>
     * </ul>
     * </p>
     *
     * @return The cache.
