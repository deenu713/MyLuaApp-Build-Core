 ...
 * taking a single closure or {@link org.gradle.api.Action} parameter. The method calls the {@link Task#configure(Action)} method for the
...
public interface Project extends Comparable<Project>, ExtensionAware, PluginAware {
     ...
     * @throws InvalidUserDataException If a task with the given name already exists in this project.
     */
    Task task(Map<String, ?> args, String name, Action<? super Task> configureClosure);
     ...
     */
    Object configure(Object object, Action<Object> configureClosure);
     ...
     */
    void repositories(Action<? super RepositoryHandler> configureClosure);
     ...
     */
    void dependencies(Action<? super DependencyHandler> configureClosure);
