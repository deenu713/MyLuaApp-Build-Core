...
public interface Script {
     ...
     */
    void apply(Action<? super ObjectConfigurationAction> closure);
     ...
     */
    void buildscript(Action<? super ScriptHandler> configureClosure);
     ...
     * using the given closure. This method works as described for {@link Project#files(Object,Action)}.
     ...
     */
    ConfigurableFileCollection files(Object paths, Action<? super ConfigurableFileCollection> configureClosure);
     ...
     * @return the configured file tree. Never returns null.
     */
    ConfigurableFileTree fileTree(Object baseDir, Action<? super ConfigurableFileTree> configureClosure);
     ...
     */
    WorkResult copy(Action<? super CopySpec> closure);
     ...
     * @return The CopySpec
     */
    CopySpec copySpec(Action<? super CopySpec> closure);
