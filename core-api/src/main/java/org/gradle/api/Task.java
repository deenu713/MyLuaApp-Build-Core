 ...
 * the task as parameter.  You can add action closures to a task by calling {@link #doFirst(Action)} or
 * {@link #doLast(Action)}.</p>
 *
 ...
 * {@link org.gradle.api.tasks}. A task action can abort execution of the task and continue to the
...
public interface Task extends Comparable<Task>, ExtensionAware {
     ...
     * @return This task
     */
    Task configure(Action<? super Task> configureClosure);
