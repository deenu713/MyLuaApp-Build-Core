...
public abstract class MixInClosurePropertiesAsMethodsDynamicObject extends CompositeDynamicObject {
    ...
    public DynamicInvokeResult tryInvokeMethod(String name, Object... arguments) {
        ...
        if (propertyResult.isFound()) {
            ...
            if (property instanceof NamedDomainObjectContainer && arguments.length == 1 && arguments[0] instanceof Function) {
                ((NamedDomainObjectContainer) property).configure((Function) arguments[0]);
