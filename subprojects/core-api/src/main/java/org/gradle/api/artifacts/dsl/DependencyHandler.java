...
public interface DependencyHandler extends ExtensionAware {
     ...
     * @return The dependency.
     */
    Dependency add(String configurationName, Object dependencyNotation, Action<? super Dependency> configureClosure);
     ...
     * @return The dependency.
     */
    Dependency create(Object dependencyNotation, Action<? super Dependency> configureClosure);
     ...
     * @return The dependency.
     */
    Dependency module(Object notation, Action<? super Dependency> configureClosure);
