...
public class FactoryNamedDomainObjectContainer<T> extends AbstractNamedDomainObjectContainer<T> {
     ...
     */
    public FactoryNamedDomainObjectContainer(Class<T> type, Instantiator instantiator, final Function<String,? extends T> factoryClosure, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
     ...
     */
    public FactoryNamedDomainObjectContainer(Class<T> type, Instantiator instantiator, Namer<? super T> namer, final  Function<String,? extends T> factoryClosure, MutationGuard mutationGuard, CollectionCallbackActionDecorator collectionCallbackActionDecorator) {
    ...
    private static class ClosureObjectFactory<T> implements NamedDomainObjectFactory<T> {
        ...
        private final  Function<String,? extends T> factoryClosure;

        public ClosureObjectFactory(Class<T> type,  Function<String,? extends T> factoryClosure) {
            this.type = type;
