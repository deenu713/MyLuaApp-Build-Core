...
public abstract class DefaultProject extends AbstractPluginAware implements ProjectInternal, DynamicObjectAware {
    ...
    @Override
    public void setScript(Object buildScript) {
    ...
    @Override
    public Object configure(Object object, Action configureClosure) {
        configureClosure.execute(object);
        return object;
    }
    ...
    @Override
    public void repositories(Action<? super RepositoryHandler> configureClosure) {
        configureClosure.execute(getRepositories());
    }

    @Override
    public void dependencies(Action<? super DependencyHandler> configureClosure) {
        configureClosure.execute(getDependencies());
    }
    ...
    @Override
    public void buildscript(Action<? super ScriptHandler> configureClosure) {
        configureClosure.execute(getBuildscript());
    }
