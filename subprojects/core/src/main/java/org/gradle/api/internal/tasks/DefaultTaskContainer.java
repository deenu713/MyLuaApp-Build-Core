...
public class DefaultTaskContainer extends DefaultTaskCollection<Task> implements TaskContainerInternal {
    ...
    @Override
    public Task create(Map<String, ?> options, Action<? super Task> configureClosure) throws InvalidUserDataException {
        return doCreate(options, configureClosure);
    }
    ...
    @Override
    public NamedDomainObjectContainer<Task> configure(Function<NamedDomainObjectContainer<Task>, NamedDomainObjectContainer<Task>> cl) {
        return cl.apply(this);
    }
