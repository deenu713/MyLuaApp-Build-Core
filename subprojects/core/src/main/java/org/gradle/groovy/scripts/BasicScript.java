...
public abstract class BasicScript extends Script implements org.gradle.api.Script, DynamicObjectAware, GradleScript {
    ...
    private static final class ScriptDynamicObject extends AbstractDynamicObject {
        ...
        public boolean hasProperty(String name) {
            return scriptObject.hasProperty(name) || dynamicTarget.hasProperty(name);
        }
